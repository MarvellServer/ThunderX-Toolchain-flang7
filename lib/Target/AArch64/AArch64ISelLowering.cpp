...
AArch64TargetLowering::AArch64TargetLowering(const TargetMachine &TM,
  ...
  // New Intrinsics.
#if 0
  setOperationAction(ISD::FACOS,   MVT::f32, Expand);
  setOperationAction(ISD::FACOS,   MVT::f64, Expand);
  setOperationAction(ISD::FASIN,   MVT::f32, Expand);
  setOperationAction(ISD::FASIN,   MVT::f64, Expand);
  setOperationAction(ISD::FATAN,   MVT::f32, Expand);
  setOperationAction(ISD::FATAN,   MVT::f64, Expand);
  setOperationAction(ISD::FATAN2,  MVT::f32, Expand);
  setOperationAction(ISD::FATAN2,  MVT::f64, Expand);
  setOperationAction(ISD::FTAN,    MVT::f32, Expand);
  setOperationAction(ISD::FTAN,    MVT::f64, Expand);
  setOperationAction(ISD::FCOSH,   MVT::f32, Expand);
  setOperationAction(ISD::FCOSH,   MVT::f64, Expand);
  setOperationAction(ISD::FSINH,   MVT::f32, Expand);
  setOperationAction(ISD::FSINH,   MVT::f64, Expand);
  setOperationAction(ISD::FTANH,   MVT::f32, Expand);
  setOperationAction(ISD::FTANH,   MVT::f64, Expand);
  setOperationAction(ISD::FASINH,  MVT::f32, Expand);
  setOperationAction(ISD::FASINH,  MVT::f64, Expand);
  setOperationAction(ISD::FACOSH,  MVT::f32, Expand);
  setOperationAction(ISD::FACOSH,  MVT::f64, Expand);
  setOperationAction(ISD::FATANH,  MVT::f32, Expand);
  setOperationAction(ISD::FATANH,  MVT::f64, Expand);
  setOperationAction(ISD::FLGAMMA, MVT::f32, Expand);
  setOperationAction(ISD::FLGAMMA, MVT::f64, Expand);
  setOperationAction(ISD::FTGAMMA, MVT::f32, Expand);
  setOperationAction(ISD::FTGAMMA, MVT::f64, Expand);
  setOperationAction(ISD::FEXP10,  MVT::f32, Expand);
  setOperationAction(ISD::FEXP10,  MVT::f64, Expand);
#endif
  // Vectors.
#if 0
  setOperationAction(ISD::FACOS,   MVT::v2f64, Promote);
  setOperationAction(ISD::FACOS,   MVT::v4f32, Promote);
  setOperationAction(ISD::FACOSH,  MVT::v2f64, Promote);
  setOperationAction(ISD::FACOSH,  MVT::v4f32, Promote);
  setOperationAction(ISD::FASIN,   MVT::v2f64, Promote);
  setOperationAction(ISD::FASIN,   MVT::v4f32, Promote);
  setOperationAction(ISD::FASINH,  MVT::v2f64, Promote);
  setOperationAction(ISD::FASINH,  MVT::v4f32, Promote);
  setOperationAction(ISD::FATAN,   MVT::v2f64, Promote);
  setOperationAction(ISD::FATAN,   MVT::v4f32, Promote);
  setOperationAction(ISD::FATANH,  MVT::v2f64, Promote);
  setOperationAction(ISD::FATANH,  MVT::v4f32, Promote);
  setOperationAction(ISD::FATAN2,  MVT::v2f64, Promote);
  setOperationAction(ISD::FATAN2,  MVT::v4f32, Promote);
  setOperationAction(ISD::FCOS,    MVT::v2f64, Promote);
  setOperationAction(ISD::FCOS,    MVT::v4f32, Promote);
  setOperationAction(ISD::FCOSH,   MVT::v2f64, Promote);
  setOperationAction(ISD::FCOSH,   MVT::v4f32, Promote);
  setOperationAction(ISD::FEXP,    MVT::v2f64, Promote);
  setOperationAction(ISD::FEXP,    MVT::v4f32, Promote);
  setOperationAction(ISD::FEXP2,   MVT::v2f64, Promote);
  setOperationAction(ISD::FEXP2,   MVT::v4f32, Promote);
  setOperationAction(ISD::FEXP10,  MVT::v2f64, Promote);
  setOperationAction(ISD::FEXP10,  MVT::v4f32, Promote);
  setOperationAction(ISD::FLGAMMA, MVT::v2f64, Promote);
  setOperationAction(ISD::FLGAMMA, MVT::v4f32, Promote);
  setOperationAction(ISD::FLOG,    MVT::v2f64, Promote);
  setOperationAction(ISD::FLOG,    MVT::v4f32, Promote);
  setOperationAction(ISD::FLOG2,   MVT::v2f64, Promote);
  setOperationAction(ISD::FLOG2,   MVT::v4f32, Promote);
  setOperationAction(ISD::FLOG10,  MVT::v2f64, Promote);
  setOperationAction(ISD::FLOG10,  MVT::v4f32, Promote);
  setOperationAction(ISD::FSIN,    MVT::v2f64, Promote);
  setOperationAction(ISD::FSIN,    MVT::v4f32, Promote);
  setOperationAction(ISD::FSINH,   MVT::v2f64, Promote);
  setOperationAction(ISD::FSINH,   MVT::v4f32, Promote);
  setOperationAction(ISD::FSQRT,   MVT::v2f64, Promote);
  setOperationAction(ISD::FSQRT,   MVT::v4f32, Promote);
  setOperationAction(ISD::FTAN,    MVT::v2f64, Promote);
  setOperationAction(ISD::FTAN,    MVT::v4f32, Promote);
  setOperationAction(ISD::FTANH,   MVT::v2f64, Promote);
  setOperationAction(ISD::FTANH,   MVT::v4f32, Promote);
  setOperationAction(ISD::FTGAMMA, MVT::v2f64, Promote);
  setOperationAction(ISD::FTGAMMA, MVT::v4f32, Promote);
#endif
#if 0
  setOperationAction(ISD::FACOS,   MVT::v2f64, LibCall);
  setOperationAction(ISD::FACOS,   MVT::v4f32, LibCall);
  setOperationAction(ISD::FACOSH,  MVT::v2f64, LibCall);
  setOperationAction(ISD::FACOSH,  MVT::v4f32, LibCall);
  setOperationAction(ISD::FASIN,   MVT::v2f64, LibCall);
  setOperationAction(ISD::FASIN,   MVT::v4f32, LibCall);
  setOperationAction(ISD::FASINH,  MVT::v2f64, LibCall);
  setOperationAction(ISD::FASINH,  MVT::v4f32, LibCall);
  setOperationAction(ISD::FATAN,   MVT::v2f64, LibCall);
  setOperationAction(ISD::FATAN,   MVT::v4f32, LibCall);
  setOperationAction(ISD::FATANH,  MVT::v2f64, LibCall);
  setOperationAction(ISD::FATANH,  MVT::v4f32, LibCall);
  setOperationAction(ISD::FATAN2,  MVT::v2f64, LibCall);
  setOperationAction(ISD::FATAN2,  MVT::v4f32, LibCall);
  setOperationAction(ISD::FCOS,    MVT::v2f64, LibCall);
  setOperationAction(ISD::FCOS,    MVT::v4f32, LibCall);
  setOperationAction(ISD::FCOSH,   MVT::v2f64, LibCall);
  setOperationAction(ISD::FCOSH,   MVT::v4f32, LibCall);
  setOperationAction(ISD::FEXP,    MVT::v2f64, LibCall);
  setOperationAction(ISD::FEXP,    MVT::v4f32, LibCall);
  setOperationAction(ISD::FEXP2,   MVT::v2f64, LibCall);
  setOperationAction(ISD::FEXP2,   MVT::v4f32, LibCall);
  setOperationAction(ISD::FEXP10,  MVT::v2f64, LibCall);
  setOperationAction(ISD::FEXP10,  MVT::v4f32, LibCall);
  setOperationAction(ISD::FLGAMMA, MVT::v2f64, LibCall);
  setOperationAction(ISD::FLGAMMA, MVT::v4f32, LibCall);
  setOperationAction(ISD::FLOG,    MVT::v2f64, LibCall);
  setOperationAction(ISD::FLOG,    MVT::v4f32, LibCall);
  setOperationAction(ISD::FLOG2,   MVT::v2f64, LibCall);
  setOperationAction(ISD::FLOG2,   MVT::v4f32, LibCall);
  setOperationAction(ISD::FLOG10,  MVT::v2f64, LibCall);
  setOperationAction(ISD::FLOG10,  MVT::v4f32, LibCall);
  setOperationAction(ISD::FSIN,    MVT::v2f64, LibCall);
  setOperationAction(ISD::FSIN,    MVT::v4f32, LibCall);
  setOperationAction(ISD::FSINH,   MVT::v2f64, LibCall);
  setOperationAction(ISD::FSINH,   MVT::v4f32, LibCall);
  setOperationAction(ISD::FSQRT,   MVT::v2f64, LibCall);
  setOperationAction(ISD::FSQRT,   MVT::v4f32, LibCall);
  setOperationAction(ISD::FTAN,    MVT::v2f64, LibCall);
  setOperationAction(ISD::FTAN,    MVT::v4f32, LibCall);
  setOperationAction(ISD::FTANH,   MVT::v2f64, LibCall);
  setOperationAction(ISD::FTANH,   MVT::v4f32, LibCall);
  setOperationAction(ISD::FTGAMMA, MVT::v2f64, LibCall);
  setOperationAction(ISD::FTGAMMA, MVT::v4f32, LibCall);
#endif
  // End New Intrinsics.
  ...
  // New Intrinsics.
  setOperationAction(ISD::FACOS,   MVT::f16,   Promote);
  setOperationAction(ISD::FACOS,   MVT::v4f16, Promote);
  setOperationAction(ISD::FACOS,   MVT::v8f16, Promote);
  setOperationAction(ISD::FASIN,   MVT::f16,   Promote);
  setOperationAction(ISD::FASIN,   MVT::v4f16, Promote);
  setOperationAction(ISD::FASIN,   MVT::v8f16, Promote);
  setOperationAction(ISD::FATAN,   MVT::f16,   Promote);
  setOperationAction(ISD::FATAN,   MVT::v4f16, Promote);
  setOperationAction(ISD::FATAN,   MVT::v8f16, Promote);
  setOperationAction(ISD::FATAN2,  MVT::f16,   Promote);
  setOperationAction(ISD::FATAN2,  MVT::v4f16, Promote);
  setOperationAction(ISD::FATAN2,  MVT::v8f16, Promote);
  setOperationAction(ISD::FTAN,    MVT::f16,   Promote);
  setOperationAction(ISD::FTAN,    MVT::v4f16, Promote);
  setOperationAction(ISD::FTAN,    MVT::v8f16, Promote);
  setOperationAction(ISD::FCOSH,   MVT::f16,   Promote);
  setOperationAction(ISD::FCOSH,   MVT::v4f16, Promote);
  setOperationAction(ISD::FCOSH,   MVT::v8f16, Promote);
  setOperationAction(ISD::FSINH,   MVT::f16,   Promote);
  setOperationAction(ISD::FSINH,   MVT::v4f16, Promote);
  setOperationAction(ISD::FSINH,   MVT::v8f16, Promote);
  setOperationAction(ISD::FTANH,   MVT::f16,   Promote);
  setOperationAction(ISD::FTANH,   MVT::v4f16, Promote);
  setOperationAction(ISD::FTANH,   MVT::v8f16, Promote);
  setOperationAction(ISD::FASINH,  MVT::f16,   Promote);
  setOperationAction(ISD::FASINH,  MVT::v4f16, Promote);
  setOperationAction(ISD::FASINH,  MVT::v8f16, Promote);
  setOperationAction(ISD::FACOSH,  MVT::f16,   Promote);
  setOperationAction(ISD::FACOSH,  MVT::v4f16, Promote);
  setOperationAction(ISD::FACOSH,  MVT::v8f16, Promote);
  setOperationAction(ISD::FATANH,  MVT::f16,   Promote);
  setOperationAction(ISD::FATANH,  MVT::v4f16, Promote);
  setOperationAction(ISD::FATANH,  MVT::v8f16, Promote);
  setOperationAction(ISD::FLGAMMA, MVT::f16,   Promote);
  setOperationAction(ISD::FLGAMMA, MVT::v4f16, Promote);
  setOperationAction(ISD::FLGAMMA, MVT::v8f16, Promote);
  setOperationAction(ISD::FTGAMMA, MVT::f16,   Promote);
  setOperationAction(ISD::FTGAMMA, MVT::v4f16, Promote);
  setOperationAction(ISD::FTGAMMA, MVT::v8f16, Promote);
  setOperationAction(ISD::FEXP10,  MVT::f16,   Promote);
  setOperationAction(ISD::FEXP10,  MVT::v4f16, Promote);
  setOperationAction(ISD::FEXP10,  MVT::v8f16, Promote);
  // End New Intrinsics.
