...
define void @acos_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call <2 x double> @_ZGVnN2v_acos_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @acos_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call <4 x float> @_ZGVnN4v_acosf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @asin_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call <2 x double> @_ZGVnN2v_asin_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @asin_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call <4 x float> @_ZGVnN4v_asinf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @atan_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call <2 x double> @_ZGVnN2v_atan_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @atan_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call <4 x float> @_ZGVnN4v_atanf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @atan2_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call <2 x double> @_ZGVnN2vv_atan2_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @atan2_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call <4 x float> @_ZGVnN4vv_atan2f_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @cos_f64(double* nocapture %varray) {
  ; CHECK-LABEL: @cos_f64(
  ; CHECK:    [[TMP5:%.*]] = call <2 x double> @_ZGVnN2v_cos_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @cos_f32(float* nocapture %varray) {
  ; CHECK-LABEL: @cos_f32(
  ; CHECK:    [[TMP5:%.*]] = call <4 x float> @_ZGVnN4v_cosf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @cosh_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call <2 x double> @_ZGVnN2v_cosh_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @cosh_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call <4 x float> @_ZGVnN4v_coshf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @log_f64(double* nocapture %varray) {
  ; CHECK-LABEL: @log_f64(
  ; CHECK:    [[TMP5:%.*]] = call <2 x double> @_ZGVnN2v_log_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @log_f32(float* nocapture %varray) {
  ; CHECK-LABEL: @log_f32(
  ; CHECK:    [[TMP5:%.*]] = call <4 x float> @_ZGVnN4v_logf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @sin_f64(double* nocapture %varray) {
  ; CHECK-LABEL: @sin_f64(
  ; CHECK:    [[TMP5:%.*]] = call <2 x double> @_ZGVnN2v_sin_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @sin_f32(float* nocapture %varray) {
  ; CHECK-LABEL: @sin_f32(
  ; CHECK:    [[TMP5:%.*]] = call <4 x float> @_ZGVnN4v_sinf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @sinh_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call <2 x double> @_ZGVnN2v_sinh_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @sinh_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call <4 x float> @_ZGVnN4v_sinhf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @sqrt_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call <2 x double> @_ZGVnN2v_sqrt_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @sqrt_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call <4 x float> @_ZGVnN4v_sqrtf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @tan_f64(double* nocapture %varray) {
  ; CHECK-LABEL: @tan_f64(
  ; CHECK:    [[TMP5:%.*]] = call <2 x double> @_ZGVnN2v_tan_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @tan_f32(float* nocapture %varray) {
  ; CHECK-LABEL: @tan_f32(
  ; CHECK:    [[TMP5:%.*]] = call <4 x float> @_ZGVnN4v_tanf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @tanh_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call <2 x double> @_ZGVnN2v_tanh_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @tanh_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call <4 x float> @_ZGVnN4v_tanhf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
