...
struct InfoByHwMode {
  ...
  InfoByHwMode(const InfoByHwMode& RHS) = default;
  InfoByHwMode(InfoByHwMode&& RHS) = default;
  InfoByHwMode(const MapType &M) : Map(M) {}

  InfoByHwMode& operator=(const InfoByHwMode& RHS) {
    if (this != &RHS) {
      Map = RHS.Map;
    }
  ...
  InfoByHwMode& operator=(InfoByHwMode&& RHS) {
    if (this != &RHS) {
